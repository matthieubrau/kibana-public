define(function (require) {
  ...
  return function (Private, $rootScope, getAppState, globalState) {
    ...
    queryFilter.removeAndFilter = function (matchFilter, key) {
      var filter = _.omit(matchFilter, ['$$hashKey']);
      filter.bool.must.splice(key, 1);
    }
    queryFilter.removeNorFilter = function (matchFilter, key) {
      var filter = _.omit(matchFilter, ['$$hashKey']);
      filter.bool.must_not.splice(key, 1);
    }
